      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Vizly empowers you to derive meaningful insights quickly, whether you're engaged in academic research, teaching, data analysis, or driving business decisions.
          </p>
        </div>
